    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a >Principiante </a> <span class="lnr lnr-arrow-right"></span>  <a >   Equipos de hasta 2 estudiantes, con edades hasta 12 años (no deben
                        cumplir 13 años el 2019) y un tutor o tutora. Los proyectos deben ser del tipo Mecánico,
                        Hidráulico y neumático.</a></p>
            </div>
        </div>
    </div>
</section>
...
<script !src="">
    ...
    window.onload=function (e) {
        ...
        var db = firebase.firestore().collection("cprincipiante");
