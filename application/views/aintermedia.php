    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a >Intermedia </a> <span class="lnr lnr-arrow-right"></span>  <a >Equipos de 2 estudiantes con edades entre 13 y 15 años (no deben
                        cumplir 16 años en 2019) y un tutor o tutora.  </a></p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="modal-body">
                <form id="notas">
                    <div class="form-group">
                        <label for="p1">Foco inteligente Rojo/Amarillo/Azul/Verde: <br>
                            •	Foco Vertical en la habitación correcta (mismo color) y <br>
                            •	Completamente dentro del AREA 1 o AREA 2
                        </label>
                        <div class="row">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Cada una 25. Total 150.
                        </small>
                    </div>
                    <div class="form-group">
                        <label for="p2">Foco inteligente Rojo/Amarillo/Azul/Verde: <br>
                            •	Foco No Vertical pero en la habitación correcta (mismo color) y <br>
                            •	Completamente dentro del AREA 1 o AREA 2
                        </label>
                        <div class="row">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Cada una 15. Total 90.
                        </small>
                    </div>
                    <div class="form-group">
                        <label for="p3">Foco inteligente Rojo/Amarillo/Azul/Verde: b <br>
                            •	Foco Vertical en la habitación correcta (mismo color) y <br>
                            •	Parcialmente dentro del AREA 1 o AREA 2 <br>
                        </label>
                        <div class="row">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Cada una 10. Total 60.
                        </small>
                    </div>
                    <div class="form-group">
                        <label for="p4">Foco inteligente Rojo/Amarillo/Azul/Verde: <br>
                            •	Foco No Vertical pero en la habitación correcta (mismo color) <br>
                            •	Parcialmente dentro del AREA 1 o AREA 2
                        </label>
                        <div class="row">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Cada una 5. Total 30.
                        </small>
                    </div>
                    <div class="form-group">
                        <label for="p5">Foco negro: <br>
                            •	Foco Vertical en el Área de Desperdicios y <br>
                            •	Completamente dentro del  Área de Desperdicios
                        </label>
                        <div class="row">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Cada una 20. Total 40.
                        </small>
                    </div>
                    <div class="form-group">
                        <label for="p6">Foco negro: <br>
                            •	Foco No Vertical en el Área de Desperdicios y <br>
                            •	Completamente dentro del Área de Desperdicios
                        </label>
                        <div class="row">
                    ...
                    <div class="form-group">
                        <label for="p7">Foco negro: <br>
                            •	Foco Vertical o No Vertical en el Área de Desperdicios y <br>
                            •	Parcialmente dentro del Área de Desperdicios <br>
                        </label>
                        <div class="row">
                    ...
                    <div class="form-group">
                        <label for="p9">Los estudiantes construyeron y programaron su propio robot. Si hubiera razones suficientes para afirmar que se trata de un plagio. El equipo será desclasificado.</label>
                        <div class="row">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Total 89.
                        </small>
                    </div>
                    <div class="form-group">
                        <label for="p10">Penalidad: El robot daña o desplaza una pared de su posición inicial.</label>
                        <div class="row">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Cada una -15. Total -45.
                        </small>
                    </div>
                    <div class="form-group">
...
<script !src="">
    ...
    window.onload=function (e) {
        ...
        var db = firebase.firestore().collection("aintermedia");
